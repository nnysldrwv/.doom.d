  ...
  (setq org-capture-templates
        '(("a" "Append Note" plain
          ...
          ("w" "w · 精读笔记 [ref/]" plain (function my/capture-web-article-target)
           "%?"
           :empty-lines 1 :jump-to-captured t)
          ("h" "Habit" entry (file "~/org/notes/20260101T000018--habits-hub__habit_index.org")
          ...
          ("Ic" "招行转入/转出" plain
           ...
           "" :immediate-finish t)
          ("It" "担保品划转" plain
           (function my/beancount-record-collateral-transfer)
           "" :immediate-finish t)
          ("Im" "融资买入" plain
           (function my/beancount-record-margin-buy)
           "" :immediate-finish t)
          ("IM" "融资卖出" plain
           (function my/beancount-record-margin-sell)
           "" :immediate-finish t))))
#+end_src
