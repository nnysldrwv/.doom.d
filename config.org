...
** Fonts
拉丁用 Ubuntu Mono, 汉字用 Sarasa Mono SC。
#+begin_src emacs-lisp
;; Doom 自带的字体变量配置
(setq doom-font (font-spec :family "Ubuntu Mono" :size 22)
      ...
      doom-variable-pitch-font (font-spec :family "Ubuntu Mono" :weight 'extra-bold))
