...
(defconst my/beancount-funds
  '(("159501" :name "嘉实纳斯达克100ETF(QDII)" :commodity "ETF159501"
    ...
    ("563510" :name "易方达中证A500红利低波动ETF" :commodity "ETF563510"
     :account "Assets:Investment:DividendLowVol:ETF563510" :category "红利低波")
    ("159209" :name "招商中证全指红利质量ETF" :commodity "ETF159209"
     :account "Assets:Investment:DividendQuality:ETF159209" :category "红利质量")
    ("159307" :name "红利低波100ETF" :commodity "ETF159307"
     :account "Assets:Investment:DividendLowVol:ETF159307" :category "红利低波")
...
(defun my/beancount-record-price ()
  "快速记录一条 ETF/基金净值 price。"
  (interactive)
  (let* ((date (my/beancount--read-date "净值日期: "))
         (code (my/beancount--read-fund-code))
         (commodity (plist-get (my/beancount--fund code) :commodity))
