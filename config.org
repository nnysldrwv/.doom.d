...
* HeadeWelcome to the Emacs shell

~/.doom.d $ r
Lexical binding must be the very first line of the tangled file.
 
#+begin_src emacs-lisp
;;; config.el -*- lexical-binding: t; -*-
#+end_src

* 0. Windows: Force UTF-8 (Disabled)
These Windows encoding workarounds are kept as reference but currently disabled.
...
* 14. Chinese Calendar (cal-china-x)
#+begin_src emacs-lisp
...
* 18. Fix: C-c C-c in *Org Note* Buffer
